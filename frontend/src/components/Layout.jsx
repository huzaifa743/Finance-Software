...
const nav = [
  ...
  { path: '/purchases', label: 'Purchases & Suppliers', icon: Truck },
  { path: '/expenses', label: 'Expenses & Petty Cash', icon: Wallet },
  { path: '/cash', label: 'Cash Management', icon: Banknote },
  { path: '/banks', label: 'Banks', icon: Landmark },
  { path: '/pl', label: 'Profit & Loss', icon: TrendingUp },
  { path: '/staff', label: 'Staff & Salary', icon: Users },
  { path: '/assets', label: 'Assets & Loans', icon: Package },
